...
class ReportIssueActivity : AppCompatActivity() {
    ...
    private lateinit var imgIssue: android.widget.ImageView
    ...
    private val galleryLauncher = registerForActivityResult(
        ...
        uri?.let {
            ...
            imgIssue.scaleType = android.widget.ImageView.ScaleType.CENTER_CROP
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Photo click
        layoutAddPhoto.setOnClickListener { showImagePickerDialog() }
        imgIssue.setOnClickListener { showImagePickerDialog() }
        ...
        val priorities = listOf("Select Priority", "Low", "Medium", "High")
    ...
    private fun submitReport() {
        ...
        selectedImageUri?.let { uri ->
            ...
            if (savedPath != null) localPhotoPath = savedPath
        }
